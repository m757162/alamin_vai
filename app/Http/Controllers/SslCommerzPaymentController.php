...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        return view('payments.exampleEasycheckout');
    }

    public function sslcommercz()
    {
        return view('payments.sslcommercz');
    }
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_name'] = $client->name;
        ...
        $post_data['value_b'] = $client_id; //client id
    ...
    public function success(Request $request)
    {
        ...
        $client_id = $request->input('value_b');
        ...
        if ($order->payment_status == 'unpaid') {
            ...
            if ($validation == TRUE) {
                ...
                */
                ...
                $order->payment_method = 'sslcommercz';
                $order->payment_info = json_encode($payment_info);
                $order->save();

                if($order){
                    $this->wallet_transaction('client', $client_id, $amount, 'Hire freelancer');
                }
